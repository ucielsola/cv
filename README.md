...
**Frameworks & Tools:** **Svelte** & **SvelteKit** (**Svelte 5**), **Angular** (**v14–v18**, ~3 yrs, last used Dec 2024), **Capacitor** (**v5–v8**), **RxJS**, React, Ionic, TailwindCSS, Vite, Node.js, pnpm, Git / GitLab CI, Bash, Linux, macOS
